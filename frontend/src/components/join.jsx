...
const Join = () => {
  ...
  return (
    ...
    <div className={'h-full w-8/10 pt-11  bg-[#F4F9FF] text-xl text-[#1A1A1A] dark:bg-primary-dark dark:text-[#F1F1F1] transition-all duration-500 ease-in-out fixed right-0 '
     + ((show != "show") ? 'w-full' : '')
    }>
      Join
    </div >
