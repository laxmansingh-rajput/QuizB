...
const SideBar = ({ curr }) => {
    ...
    return (
        <>
            <div className={'h-full max-[650px]:w-3/4 max-[750px]:w-1/2 max-[950px]:w-1/4 w-2/10 border-black fixed left-0 pt-16 pl-3 pr-3 flex flex-col gap-4 bg-primary text-xl text-primary-text dark:text-primary-dark-text '
                + 'dark:bg-primary-dark text-primary-dark-text transition-all duration-500 ease-in-out z-45 shadow dark:shadow-amber-50' + ((show != "show") ?
                    " w-0 hidden " : "")}>

                <div className='relative p-2'>
                    <div className='flex items-center justify-start gap-3 cursor-pointer' onClick={handelHome}>
                        <div className={'border-1 rounded-md transition-all duration-500 ease-in-out h-7 w-0 absolute left-0 ' + ((curr === "home") ? "w-full h-10 border-[1px] text-primary-card-text " : "")}></div>
                ...
                <div className='relative p-2'>
                    <div className='flex items-center justify-start gap-3 cursor-pointer' onClick={handelCreate}>
                        <div className={'border-1 rounded-md transition-all duration-500 ease-in-out h-7 w-0 absolute left-0 ' + ((curr === "create") ? "w-full h-10 border-[1px]  text-primary-card-text" : "")}></div>
                ...
                <div className='relative p-2'>
                    <div className='flex items-center justify-start gap-3 cursor-pointer' onClick={handelJoin}>
                        <div className={'border-1 rounded-md transition-all duration-500 ease-in-out h-7 w-0 absolute left-0 ' + ((curr === "join") ? "w-full h-10 border-[1px] text-primary-card-text" : "")}></div>
                ...
                <div className='relative p-2'>
                    <div className='flex items-center justify-start gap-3 cursor-pointer' onClick={handelpractice}>
                        <div className={'border-1 rounded-md transition-all duration-500 ease-in-out h-7 w-0 absolute left-0 ' + ((curr === "practice") ? "w-full h-10 border-[1px] text-primary-card-text" : "")}></div>
                ...
                <div className='relative p-2'>
                    <div className='flex items-center justify-start gap-3 cursor-pointer' onClick={handelCreation}>
                        <div className={'border-1 rounded-md transition-all duration-500 ease-in-out h-7 w-0 absolute left-0 ' + ((curr === "creation") ? "w-full h-10 border-[1px] text-primary-card-text" : "")}></div>
                ...
                <div className='relative p-2'>
                    <div className='flex items-center justify-start gap-3 cursor-pointer' onClick={handelPremium}>
                        <div className={'border-1 rounded-md transition-all duration-500 ease-in-out h-7 w-0  absolute left-0 ' + ((curr === "premium") ? "w-full h-10 border-[1px] text-primary-card-text" : "")}></div>
                ...
                <div className='relative p-2'>
                    <div className='flex items-center justify-start gap-3 cursor-pointer' onClick={handelFaq}>
                        <div className={'border-1 rounded-md transition-all duration-500 ease-in-out h-7 w-0  absolute left-0 ' + ((curr === "faq") ? "w-full h-10 border-[1px] text-primary-card-text" : "")}></div>
